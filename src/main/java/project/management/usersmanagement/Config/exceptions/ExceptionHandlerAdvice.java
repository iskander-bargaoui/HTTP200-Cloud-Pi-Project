...
public class ExceptionHandlerAdvice {
	...
	public ResponseEntity<ApiResponse> conflict(DataIntegrityViolationException ex){
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse(), HttpStatus.CONFLICT);
	}
...
//	}
	...
	public ResponseEntity<ApiResponse> validationException(ValidationException ex){
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse(), HttpStatus.UNPROCESSABLE_ENTITY);
	}
