...
public class UserService {
    ...
    public ResponseDto signUp(SignupDto signupDto)  throws CustomException {
        ...
        User user = new User(signupDto.getFirstName(), signupDto.getLastName(), signupDto.getEmail(), Role.worker, encryptedPassword );
    ...
    boolean canCrudUser(User userUpdating, Integer userIdBeingUpdated) {
        ...
        // worker can update his own record, but not his role
        if (role == Role.worker  && userUpdating.getId() == userIdBeingUpdated) {
            return true;
        }
        return false;
    }
